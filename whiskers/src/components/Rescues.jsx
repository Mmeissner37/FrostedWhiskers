    ...
    <div class="local_rescues">
      ...
      <div class="grid-container2">
        <div class="grid-item2">
          ...
          <a href="http://dakotasdream.org/" target="_blank">
            <img src={DakotasDream} alt="Dakota's Dream Logo" />
          </a>
        </div>
        <div class="grid-item2">
          <h4>SPCA Nova</h4>
          <a href="https://spcanova.org/" target="_blank">
            <img src={SPCA} alt="SPCA Nova Logo" />
          </a>
        </div>
        <div class="grid-item2">
          <h4>Frederick County Esther Boyd Animal Shelter</h4>
          <a
            href="https://www.fcva.us/departments/animal-shelter"
            target="_blank"
          >
            <img
              src={Esther}
